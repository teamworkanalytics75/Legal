...
- WORKFLOW‑018 — Update fact verification rules — pending — P0 — area: workflow
- WORKFLOW‑019 — Fix cluster-based validation blocking — completed — P0 — area: workflow
- WORKFLOW‑020 — Add cluster satisfaction override — pending — P0 — area: workflow
- WORKFLOW‑021 — Fix constraint system path resolution — pending — P0 — area: workflow
- WORKFLOW‑022 — Improve fact injection prompts — pending — P0 — area: workflow
