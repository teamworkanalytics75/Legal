#!/usr/bin/env python3
"""
Clean Google Drive 1782 Cases - Complete
...
def clean_gdrive_folder_complete():
...
if __name__ == "__main__":
    print("Clean Google Drive 1782 Cases - Complete")
    print("=" * 50)

    kept, removed = clean_gdrive_folder_complete()
